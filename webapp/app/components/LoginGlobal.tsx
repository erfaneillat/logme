        ...
        >
            ...
            <div className="flex-1 flex flex-col justify-end max-w-sm mx-auto w-full px-8 pb-8">
                ...
                <p className="text-xs text-center text-gray-500 leading-relaxed max-w-xs mx-auto">
                    ...
                    <a href="#" className="text-emerald-600 hover:underline">{t('loginGlobal.termsLink')}</a>
                    {' '}{t('loginGlobal.and')}{' '}
                    <a href="#" className="text-emerald-600 hover:underline">{t('loginGlobal.privacyLink')}</a>
                </p>
            </div>
        </motion.div>
    );

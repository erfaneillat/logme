    ...
    final testimonials = [
      {
        'name': 'مونا',
        'text':
            'قبلاً با اپ‌های کالری‌شمار باید اسم تک‌تک غذاها رو می‌نوشتم، واقعاً خسته‌کننده بود. لقمه رو نصب کردم، فقط یه عکس گرفتم و خودش همه‌چی رو گفت. خیلی دقیق‌تر از چیزی بود که فکر می‌کردم!',

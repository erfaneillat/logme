...
Future<void> showStreakDialog(
  ...
  await showDialog(
    ...
    builder: (ctx) {
      ...
      const jalaliWeekLetters = ['ش', 'ی', 'د', 'س', 'چ', 'پ', 'ج'];
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text('app_title'.tr(), style: Theme.of(context).textTheme.labelLarge),
                  const Spacer(),
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('$streakCount', style: Theme.of(context).textTheme.labelSmall),
                      ],
                    ),
                  ),
                ],
              ...
              Text('home.streak_title'.tr(),
                  style: Theme.of(context)
                      .textTheme
                      .titleLarge
                      ?.copyWith(fontWeight: FontWeight.w700, color: Colors.orange)),
                ...
                children: [
                  for (var i = 0; i < 7; i++)
                    Builder(builder: (_) {
                      ...
                      final letter = jalaliWeekLetters[(j.weekDay - 1) % 7];
                      return Column(
                        children: [
                          Text(letter,
                              style: Theme.of(context)
